...
//SearchAvailabilityByRoomID returns true if availability exist, and false if no availability exist
...
//SearchAvaliabilityForAllRooms returns a slice of available room
...
func (m *postgresDBRepo) GetRoomByID(id int) (models.Room, error) {
	...
	query := `
	select id, room_name, created_at from rooms where id = $1
`
